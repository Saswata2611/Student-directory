  ...
  return (
    <main className={styles.main}>
        <div className={styles.dropdown} style={{ transform: `${transform}` }}>
            ...
            <li className={styles.li}>Batch</li>
            <li className={styles.li}>Tasks</li>
          </ul>
        </div>
        ...
        <div className={styles.tab}>
          ...
          <div className={styles.overlay}>
            ...
            <div className={styles.details}>
                <p className={styles.faculty_name}>Student Name</p>
                <ul>
                    <li className={styles.li_ele}>JIS University</li>
                    <li className={styles.li_ele}>( B.tech CSE )</li>
                    <li className={styles.li_ele}>[ 3rd Year - 6th SEM ]</li>
                </ul>
            </div>
          </div>
        </div>
